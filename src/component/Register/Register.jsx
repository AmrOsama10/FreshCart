...
export default function Register() {
  ...
  <h1 className="text-xl font-bold text-center text-green-800 dark:text-gray-200 mb-8">Welcome to FreshCart</h1>
  <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
    <div className="flex items-start flex-col justify-start">
      <label htmlFor="firstName" className="text-sm text-green-800 dark:text-gray-200 mr-2">Name:</label>
      <input onBlur={handleBlur} onChange={handleChange} value={values.name} type="text" id="firstName" name="name" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500" />
    ...
    <div className="flex items-start flex-col justify-start">
      <label htmlFor="confirmPassword" className="text-sm text-green-800 dark:text-gray-200 mr-2">Confirm Password:</label>
    ...
    <div className="flex items-start flex-col justify-start">
      <label htmlFor="phone" className="text-sm text-green-800 dark:text-gray-200 mr-2">Phone:</label>
  ...
  <div className="mt-4 text-center">
    <span className="text-sm text-gray-900 dark:text-gray-300 font-semibold">Already have an account? </span>
