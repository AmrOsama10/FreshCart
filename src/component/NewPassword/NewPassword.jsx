...
export default function NewPassword() {
  ...
  <h1 className="text-4xl font-bold text-center text-green-800 dark:text-gray-200 mb-8 ">New Password</h1>
  <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
    ...
    <div className="flex items-start flex-col justify-start">
      <label htmlFor="newPassword" className="text-sm text-green-800 dark:text-gray-200 mr-2">newPassword:</label>
