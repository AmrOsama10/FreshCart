...
const { cartId } = useParams();
  ...
  <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
      ...
      <label htmlFor="city" className="text-sm text-green-800 dark:text-gray-200 mr-2">City:</label>
    ...
    <div className="flex items-start flex-col justify-start">
      <label htmlFor="details" className="text-sm text-green-800 dark:text-gray-200 mr-2">Details:</label>
    ...
    <div className="flex items-start flex-col justify-start">
      ...
      <input onBlur={handleBlur}  onChange={handleChange} value={values.phone} type="text" id="phone" name="phone" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500" />
